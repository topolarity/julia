...
ifeq ($(OS),Darwin)
# Stage bundled libSystem.tbd next to the compiler-rt archive the JLL extracts
julia-deps: $(build_libdir)/darwin/libSystem.tbd
$(build_libdir)/darwin/libSystem.tbd: $(JULIAHOME)/contrib/mac/libSystem.tbd | $(build_libdir)
	@mkdir -p $(dir $@)
	$(INSTALL_M) $< $@
endif
...
ifeq ($(OS),Darwin)
	...
	$(INSTALL_M) $(build_libdir)/darwin/libclang_rt.osx.a $(DESTDIR)$(private_libdir)/
	$(INSTALL_M) $(build_libdir)/darwin/libSystem.tbd $(DESTDIR)$(private_libdir)/
endif
endif
