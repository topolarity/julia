...
function create_expr_cache(pkg::PkgId, input::String, output::String, output_o::Union{Nothing, String},
        concrete_deps::typeof(_concrete_dependencies), internal_stderr::IO = stderr, internal_stdout::IO = stdout; env::Dict{String, String} = Dict{String,String}())
...
function compilecache(pkg::PkgId, internal_stderr::IO = stderr, internal_stdout::IO = stdout;
    ...
    return compilecache(pkg, path, internal_stderr, internal_stdout; env)
end

const MAX_NUM_PRECOMPILE_FILES = Ref(10)

function compilecache(pkg::PkgId, path::String, internal_stderr::IO = stderr, internal_stdout::IO = stdout,
                      keep_loaded_modules::Bool = true; env::Dict{String,String} = Dict{String, String}())
    ...
    try
        ...
        p = create_expr_cache(pkg, path, tmppath, tmppath_o, concrete_deps, internal_stderr, internal_stdout; env)
