...
jl_value_t *jl_precompile_done_func JL_GLOBALLY_ROOTED = NULL;
...
JL_DLLEXPORT void jl_set_precompile_done_func(jl_value_t *f)
{
    jl_precompile_done_func = (jl_value_t*)f;
}
