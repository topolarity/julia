...
// Pin (or unpin, with world==0) the world age used to dispatch the Julia-side
// lowerer. Called by `JuliaLowering.activate!` when the lowerer is installed or
// removed, so that reinstalling an updated lowerer (e.g. under Revise) captures
// a fresh world.
