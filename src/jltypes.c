...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_method_type =
        jl_new_datatype(jl_symbol("Method"), core,
                        ...
                        jl_perm_symsvec(35,
                            ...
                            "interface_interferences", // atomic
    ...
    const static uint32_t method_atomicfields[] = { 0x800000f0, 0x0 }; // (1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<31)
    ...
    jl_interface_match_type = jl_new_datatype(jl_symbol("InterfaceMatch"), core, jl_any_type, jl_emptysvec,
                                       jl_perm_symsvec(2, "match", "rettype"),
                                       jl_svec(2, jl_method_match_type, jl_type_type),
                                       jl_emptysvec, 0, 0, 2);
    ...
    jl_svecset(jl_method_type->types, 16, jl_method_instance_type);
