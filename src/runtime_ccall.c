...
static uv_mutex_t cfun_lock; // for accesses to the closure-@cfunction trampoline cache and freelist
...
static jl_mutex_t trampoline_lock; // guards dispatch-trampoline resolution/publication
