...
define_side_metadata_specs!(
    ...
    // Immix pending-list membership (dedups `pending_blocks` pushes)
    IX_BLOCK_PENDING = (global: false, log_num_of_bits: 3, log_bytes_in_region: crate::policy::immix::block::Block::LOG_BYTES),
);
