...
void jl_gc_debug_critical_error(ios_t *s) JL_NOTSAFEPOINT
{
    jl_gc_debug_print_status(s);
...
void jl_gc_debug_print(ios_t *s)
{
...
#else
void jl_gc_debug_critical_error(ios_t *s)
{
}

void jl_gc_debug_print_status(ios_t *s)
{
