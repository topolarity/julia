...
static int trampoline_match(jl_value_t *rec, void *keyv) JL_CANSAFEPOINT
{
...
static uintptr_t trampoline_hash(jl_value_t *rec) JL_NOTSAFEPOINT
{
    (void)rec;
    return 0;
}
...
// Reinsert a materialized trampoline, keeping any existing canonical record.
