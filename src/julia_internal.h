...
void jl_gc_debug_print_status(ios_t *s) JL_NOTSAFEPOINT;
JL_DLLEXPORT void jl_gc_debug_critical_error(ios_t *s) JL_NOTSAFEPOINT;
...
void jl_print_bt_entry_codeloc(ios_t *s, jl_bt_element_t *bt_data) JL_NOTSAFEPOINT;
#ifdef _OS_WINDOWS_
