                            ...
                            uint8_t bits) JL_NOTSAFEPOINT
{
    ...
    gc_assert_parent_validity((jl_value_t *)mb_parent, (jl_value_t *)mb_parent->package);
    gc_try_claim_and_push(mq, (jl_value_t *)mb_parent->package, &nptr);
    gc_heap_snapshot_record_binding_partition_edge((jl_value_t*)mb_parent, (jl_value_t*)mb_parent->package);
