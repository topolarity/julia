...
30  (call top._defaultctors %₂₈ %₂₉)
31  latestworld
32  (call core.declare_global TestMod :#val#0 true)
33  latestworld
34  (call core.get_binding_type TestMod :#val#0)
35  (= slot₂/tmp core.nothing)
36  (call core.isa slot₂/tmp %₃₄)
37  (gotoifnot %₃₆ label₃₉)
38  (goto label₄₀)
39  (= slot₂/tmp (call top.convert %₃₄ slot₂/tmp))
40  slot₂/tmp
41  (call core.setglobal! TestMod :#val#0 %₄₀)
42  (call Base.Docs.Binding TestMod :X)
43  (call Core.svec "X docs\n")
44  (call Pair{Symbol, Any} :a "field a docs")
45  (call Pair{Symbol, Any} :b "field b docs")
46  (call Dict{Symbol, Any} %₄₄ %₄₅)
47  (call Pair :fields %₄₆)
48  (call Dict{Symbol, Any} :path => "none" :linenumber => 1 :module => TestMod %₄₇)
49  (call Base.Docs.docstr %₄₃ %₄₈)
50  TestMod.Union
51  (call core.apply_type %₅₀)
52  (call Base.Docs.doc! TestMod %₄₂ %₄₉ %₅₁)
53  (gotoifnot true label₅₆)
54  TestMod.#val#0
55  (return %₅₄)
