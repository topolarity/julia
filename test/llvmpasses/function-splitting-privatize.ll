...
; RUN: opt --load-pass-plugin=libjulia-codegen%shlibext -passes='JuliaFunctionSplitting,verify' -julia-split-function-threshold=20 -julia-split-block-threshold=16 -julia-split-block-size=16 -S %s | FileCheck %s
